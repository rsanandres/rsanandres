...
|---------|-------------|-------|
| **[Atlas AI](https://github.com/rsanandres/hc_ai)** | Clinical intelligence platform — query patient records in natural language via a 3-node multi-agent RAG pipeline with 20+ medical tools | LangGraph, FastAPI, Next.js, pgvector, Ollama |
...
| **[Ayle](https://github.com/rsanandres/ayle)** | AI agent office simulation — procedurally generated personalities (Big Five), emergent relationships, LLM-driven conversations, and a RimWorld-inspired drama director | Godot 4, GDScript, Ollama |
